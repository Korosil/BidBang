<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="Beans.UserBean" import="Beans.SendMessageBean"%>
...
<html>
    ...
    <head>
        ...
        <%
            ...
            SendMessageBean MBean = (SendMessageBean) session.getAttribute("message");
        %>
        
        <title>Μήνυμα από <%=MBean.getFrom_user()%>| BidBang.gr</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <p><strong>Από:</strong> <%=MBean.getFrom_user()%></p>
                        <p><small><%=MBean.getDate()%></small></p><br>
                        <p><strong>Μήνυμα:</strong></p>
                        <p><%=MBean.getMessage()%></p><br>
                        <a href="MessageServlet?user=<%=user.getUsername()%>"><i class="fa fa-chevron-left" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
        </section>
